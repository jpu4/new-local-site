...
echo "<?php echo '$domain ready for development';" > "$web_root/$domain/index.php"
...
sudo sed -i "s|\[WEB_ROOT\]|$web_root/$domain|g" $conf_target  # Point to the correct web root directory
